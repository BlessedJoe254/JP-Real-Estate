    ...
    <div className="p-6 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="card bg-gradient-to-br from-blue-900 to-gray-900 hover:scale-105 transform transition duration-300">
          ...
          <p className="text-gray-400 mb-4">Start or stop water flow across your zones.</p>
        ...
        <div className="card bg-gradient-to-br from-green-900 to-gray-900 hover:scale-105 transform transition duration-300">
          ...
          <p className="text-gray-400 mb-4">Define irrigation times for optimal watering.</p>
        ...
        <div className="card bg-gradient-to-br from-teal-800 to-gray-900 hover:scale-105 transform transition duration-300">
          ...
          <p className="text-gray-400 mb-4">Manage and monitor irrigation by area.</p>
